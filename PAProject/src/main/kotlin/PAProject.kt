 ...
 fun start():JsonObj{
     val Carro:JsonObj = JsonObj("Carro")
     ...
     val raioR2:JsonNumber = JsonNumber(0.4)
     val larguraR2:JsonNumber = JsonNumber(0.3)

     val raioR3:JsonNumber = JsonNumber(0.4)
     val larguraR3:JsonNumber = JsonNumber(0.2)

     val raioR4:JsonNumber = JsonNumber(0.5)
     val larguraR4:JsonNumber = JsonNumber(0.3)
...
fun main(){
    ...
    val Carro2:JsonObj=inferênciaPorReflexão()

    println("serializeAux:")
    println(serialize(Carro2))
    println("search:")
    println(Search(Carro2))
    println("search2:")
    println(Search2(Carro2))
